# Start Myrmec Control Engine with E2E profile
# Usage: .\start-engine-e2e.ps1
#
# Optional parameters:
...
Write-Step "Installing engine-spi into local Maven repo (so engine-core can resolve new SPI types)..."
...
# Step 2: run engine-core with the e2e profile.
Set-Location $EngineCoreDir

Write-Host "Starting Myrmec Control Engine (profile: e2e)..." -ForegroundColor Green
